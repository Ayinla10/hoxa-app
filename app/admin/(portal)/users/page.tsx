        ...
        <div className="flex items-start justify-between gap-4">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 flex-1">
            {[
              ...
              { label: 'Admins', value: counts.admin, icon: ShieldCheck, color: 'text-red-500', bg: 'bg-red-50' },
            ].map(s => (
          ...
          {/* Create Admin — client button to open modal */}
          <UsersPageClient />
        </div>
          ...
          <div className="hidden lg:block">
            <table className="w-full text-sm">
              <thead className="border-b border-gray-100">
                <tr>
                  {['Name', 'Email', 'Role', 'Permissions', 'Country', 'Joined', ''].map(h => (
              ...
              <div key={u.id} className="px-4 py-3 flex items-center justify-between gap-3">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    {u.role === 'admin' && u.admin_permissions.includes('super_admin') && (
                      <span className="text-[10px] font-bold text-red-500">Super Admin</span>
                    )}
                  </div>
                </div>
