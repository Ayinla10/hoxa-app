...
const dict = {
  en: {
    ...
    // Buyer portal
    nav_support: 'Support',
    find_exchange_offers: 'Find Exchange Offers',
    quick_corridors: 'Popular Corridors',
    best_exchangers: 'Best Exchangers',
    marketplace_insights: 'Marketplace Insights',
    secure_exchange_payment: 'Secure Exchange Payment',
    ...
    back_home: 'Back Home',
    complete_payment_within: 'Complete payment within',
    ...
    preparing_settlement: 'Preparing settlement',
    exchange_completed: 'Exchange completed!',
    transaction_details: 'Transaction Details',
    support_title: 'Support & Help',
    support_sub: 'Get help with your exchanges',
    no_disputes: 'No disputes',
    no_disputes_sub: 'Any disputes you open will appear here.',
  ...
  fr: {
    ...
    find_exchange_offers: 'Trouver des offres',
    quick_corridors: 'Corridors populaires',
    best_exchangers: 'Meilleurs changeurs',
    marketplace_insights: 'Aperçu du marché',
    secure_exchange_payment: 'Paiement sécurisé',
    ...
    rate_seller: 'Évaluer le changeur',
    exchange_again: 'Échanger à nouveau',
    view_receipt: 'Voir le reçu',
    back_home: 'Retour',
    complete_payment_within: 'Effectuez le paiement sous',
    active_sellers: 'changeurs actifs',
    avg_completion: 'délai moyen',
    contact_support: 'Contacter le support',
    report_issue: 'Signaler un problème',
    verification_in_progress: 'Vérification en cours',
    seller_notified: 'Changeur notifié',
    preparing_settlement: 'Préparation du règlement',
    exchange_completed: 'Change terminé !',
    transaction_details: 'Détails de la transaction',
    support_title: 'Assistance & Aide',
    support_sub: 'Obtenez de l\'aide pour vos changes',
    no_disputes: 'Aucun litige',
    no_disputes_sub: 'Les litiges que vous ouvrez apparaîtront ici.',
    issue_type: 'Type de problème',
    description: 'Description',
    evidence: 'Preuve',
    submit_dispute: 'Soumettre le litige',
    select_transaction: 'Sélectionner la transaction',
    payment_not_received: 'Paiement non reçu',
    wrong_amount: 'Montant incorrect',
    seller_unresponsive: 'Changeur ne répond pas',
    other_issue: 'Autre',
    tab_all: 'Tout',
    tab_transactions: 'Transactions',
