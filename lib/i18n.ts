...
const dict = {
  en: {
    ...
    lang_en: 'English',
    lang_fr: 'French',
    // New — checkout & exchange flow
    checkout_title: 'HOXA Protected Exchange',
    checkout_subtitle: 'Review your exchange details before confirming',
    confirm_exchange: 'Confirm Exchange',
    securing_rate: 'Securing your rate...',
    back_to_exchangers: 'Back to exchangers',
    your_send_account: 'Your send account',
    your_receive_account: 'Your receive account',
    rate_locked: 'Rate locked for',
    rate_expired: 'Rate expired — confirm for updated rate',
    waiting_title: 'Waiting for exchanger',
    waiting_sub: 'The exchanger is reviewing your request',
    waiting_note: 'You will be notified once the exchanger accepts.',
    cancel_request: 'Cancel Request',
    payment_method_title: 'Choose Payment Method',
    payment_method_sub: 'How will you send the funds?',
    pay_title: 'Send Payment',
    pay_sub: 'Complete your transfer to the account below',
    ive_paid: "I've Sent the Payment",
  ...
  fr: {
    ...
    lang_fr: 'Français',
    // New — checkout & exchange flow
    checkout_title: 'Échange Protégé HOXA',
    checkout_subtitle: 'Vérifiez les détails avant de confirmer',
    confirm_exchange: "Confirmer l'échange",
    securing_rate: 'Sécurisation du taux...',
    back_to_exchangers: 'Retour aux échangeurs',
    your_send_account: 'Votre compte envoi',
    your_receive_account: 'Votre compte réception',
    rate_locked: 'Taux verrouillé pour',
    rate_expired: 'Taux expiré — confirmer pour un nouveau taux',
    waiting_title: "En attente de l'échangeur",
    waiting_sub: "L'échangeur examine votre demande",
    waiting_note: "Vous serez notifié dès que l'échangeur accepte.",
    cancel_request: 'Annuler la demande',
    payment_method_title: 'Mode de paiement',
    payment_method_sub: 'Comment allez-vous envoyer les fonds ?',
    pay_title: 'Envoyer le paiement',
    pay_sub: 'Effectuez votre virement sur le compte ci-dessous',
    ive_paid: "J'ai envoyé le paiement",
    confirming: 'Confirmation...',
    notification_settings_title: 'Paramètres de notifications',
    push_notifications: 'Notifications push',
    push_desc: 'Recevoir des alertes sur votre appareil',
    email_notifications: 'Notifications par e-mail',
    email_desc: 'Recevoir des mises à jour par e-mail',
    enable: 'Activer',
    enabled: 'Activé',
